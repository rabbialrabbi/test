        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <div class="bread-cumb-area">
                        <h2>Paid Customers Invoices List</h2>
                        <a href="#">Dashboard</a>
                        <a href="#">Paid Customers Invoices List</a>
                    </div>
                </div>
            ...
            <div class="row new-sales-table-bg">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Exporting Paid Customers Invoices Data</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="customer-table table-responsive">
                                <table id="data" class="table table-bordered table-striped table-hover">
                                    <thead>
                                    <tr>
                                        <td class="align-middle" align="center">Invoice No</td>
                                        <td class="align-middle" align="center">Customer Name</td>
                                        <td class="align-middle" align="center">Date</td>
                                        <td class="align-middle" align="center">Total Amount</td>
                                        <td class="align-middle" align="center">Paid Amount</td>
...
<script>
    ...
    $(document).ready(function () {
        var table = $('#data').DataTable({
            responsive: true,
            dom: 'lBfrtip', processing: true, serverSide: true, "order": [[ 6, "desc" ]],
            ajax: "{{ route('paid-customer-getData') }}",
            columns: [
