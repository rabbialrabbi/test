            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="bread-cumb-area">
                        <h2>Paid Sales List</h2>
                        <a href="#">Dashboard</a>
                        <a href="#">Paid Sales List</a>
                    </div>
                </div>
                            ...
                            <div class="customer-table table-responsive">
                                <table id="data" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        ...
                                        <th class="align-middle" align="center">Discount</th>
                            ...
                            <div class="col-md-4">
                                <div class="single-revinew-two text-center">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="single-revinew-text"> <h5>{{$logo->currency}}
                                                    <?php echo number_format($discount, 2, '.', ',');?></h5>
                                                <p>Total Disocunt</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3"><div class="single-revinew-icon"> <i class="far fa-chart-bar"></i> </div></div>
