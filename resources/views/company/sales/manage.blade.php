    ...
    <div class="row dashboard-right-content">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <div class="bread-cumb-area">
                        <h2>Sales List</h2> <a href="#">Dashboard</a> <a href="#">Sales List</a>
                    </div>
                </div>
            ...
            <div class="row new-sales-table-bg">
                <div class="col-md-12">
                    <div class="row mb-2">
                        <div class="col-md-5"> <h2>Exporting Sales Data</h2> </div>
                        <div class="col-lg-7">
                ...
                @isset($invoice_no)
                <input type="hidden" name="invoice" id="invoice" value="{{$invoice_no}}">
                @endisset
                    <div class="row">
                        <div class="col-md-12">
                            <div class="customer-table table-responsive">
                                <table id="data" class="table table-bordered table-striped table-hover">
                                    <thead>
                                    <tr>
                                        <th class="align-middle" align="center">Sales No</th> <th class="align-middle" align="center">Customer Name</th>
                                        <th class="align-middle" align="center">Sales by</th> <th class="align-middle" align="center">Date</th>
                                        <th class="align-middle" align="center">Total Amount</th> <th class="align-middle" align="center">Paid Amount</th>
                                        <th class="align-middle" align="center">Due Amount</th>
                                        <th class="align-middle" align="center">Pay</th> <th class="align-middle" align="center">Option</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('sl-update')}}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            ...
                            <input type="text" class="form-control mb-3" name="cus_name" id="data_cus_name" value="" required>
                            <label for="">Seller</label><br>
                            <input type="text" class="form-control mb-3" name="seller" id="data_seller" value="" required>
                             <label for="">Total Amount</label><br>
                            <input type="text" class="form-control mb-3" id="data_grand_total" value="" readonly>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
@if(Session::get('loggedUser')['type'] === 'shop')
...
<script>
    $('#edit').on('show.bs.modal', function (event) {
        ...
        var data_id = button.data('id'); var data_cus_name = button.data('cus_name');
        var data_seller = button.data('seller'); var data_grand_total = button.data('grand_total');
        var modal = $(this);
        modal.find('.modal-body #data_id').val(data_id); modal.find('.modal-body #data_cus_name').val(data_cus_name);
        modal.find('.modal-body #data_seller').val(data_seller); modal.find('.modal-body #data_grand_total').val(data_grand_total);
    });
    $('#pay').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget);
        var data_id = button.data('id'); var data_due = button.data('due');
        var modal = $(this);
        modal.find('.modal-body #data_id').val(data_id); modal.find('.modal-body #data_due').val(data_due);
    });
    ...
    $('#invoice').click(function(){ $('#data').DataTable().draw(true); });
