            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="bread-cumb-area">
                        <h2>Loan Invoice</h2>
                        <a href="#">Dashboard</a><a href="#">Loan Invoice</a>
                    </div>
                </div>
                @if($ads1->status == 'on')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="printableArea">
                                <div class="row">
                                    <div class="col-md-9">
                                        <h1 style="font-size: 70px;">LOAN INVOICE </h1>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5> DATE OF ISSUE  {{$date}} </h5><h5> LOAN TYPE:  {{$loan->type}} </h5>
                                        <h5> CONTRACT START: <?php echo date('d-m-Y', strtotime($loan->contract_start)); ?></h5>
                                        <h5>  CONTRACT END: <?php echo date('d-m-Y', strtotime($loan->contract_end)); ?></h5>
                                        <br><br>
                                        <h5> LOAN TO </h5>
                                        <h5>{{$loan->loaner}} </h5><h5>{{$loan->mobile}} </h5>
                                    </div>
                                ...
                                <table width="100%;">
                                     <thead>
                                        <tr style="border-bottom: 4px solid #000;">
                                            <th style="width:83%"><h5>DATE</h5></th>
                                            <th style="width:10%"><h5>RETURNED AMOUNT</h5></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($pay_info as $info)
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <h5> INVOICE TOTAL </h5>
                                        <h1 style="color: #1a4993;"> {{$invoice_info->currency}} {{$loan->total_amount}} </h1>
                                    </div>
                                    <div class="col-md-9">
                                        ...
                                        <table style="width:100%;">
                                            ...
                                            <tr>
                                                <td colspan="3"></td><td><h5>GRAND TOTAL</h5></td><td><h5>{{$loan->total_amount}}</h5></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"></td><td><h5>PAID AMOUNT</h5></td><td><h5>{{$loan->returned}}</h5></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"></td><td><h5>DUE AMOUNT</h5></td><td><h5>{{$loan->remaining}}</h5></td>
                                            </tr>
                                        </table>
